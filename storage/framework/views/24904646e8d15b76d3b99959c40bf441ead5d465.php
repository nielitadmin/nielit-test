                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group <?php echo e($errors->has('session_driver') ? ' has-error ' : ''); ?>">
                            <label for="session_driver"><?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.session_label')); ?> (Read Only)
                                <sup>
                            ...
                            <input type="text" name="session_driver" id="session_driver" value="file" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.session_placeholder')); ?>" readonly="readonly"/>
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u664913565/domains/nielitbhubaneswar.in/public_html/__test/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>